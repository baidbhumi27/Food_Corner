...
if($_SESSION['loggedInRest']){
$clientID = $_SESSION['loggedInRest'];
...
<div class="cover">
 ...
 <?php
    ...
    echo "<div class='cover'><div class='cover-text'><div class='center-align'><h2>$clientID</h2> </div></div></div>";
